...
func ExportJSON(path string, id, model, integrator, controller string, dt, duration float64, result *dynamo.Result) error {
	data := ExportData{
		ID:         id,
		Model:      model,
...
func ExportJSONStdout(id, model, integrator, controller string, dt, duration float64, result *dynamo.Result) error {
	data := ExportData{
		ID:         id,
		Model:      model,
		Integrator: integrator,
